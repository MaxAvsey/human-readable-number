module.exports = function toReadable(number) {
    ...
    if (number === 0){
        ...
        result = `${words[firstNumber + '0']}`
    } else if (number > 19 && number < 100) {
        result = `${words[firstNumber + '0']} ${words[secondNumber]}`
    } else if (number > 99 && number < 1000 && secondNumber === '0' && thirdNumber === '0'){
        result = `${words[firstNumber]} hundred`
    } else if (number > 99 && number < 1000 && thirdNumber === '0'){
        result = `${words[firstNumber]} hundred ${words[secondNumber+ '0']}`
    } else if (number > 99 && number < 1000  && secondNumber === '0'){
        result = `${words[firstNumber]} hundred ${words[thirdNumber]}`
    } else if (number > 99 && number < 1000 && secondNumber === '1'){
        result = `${words[firstNumber]} hundred ${words['1' + thirdNumber]}`
    } else if (number > 99 && number < 1000){
        result = `${words[firstNumber]} hundred ${words[secondNumber+ '0']} ${words[thirdNumber]}`
    }
    return result
    }
